...
//        }
        ...
        public override void Update()
        {
            ...
            if (spawnedObjectMat != null)
            {
                ...
                spawnedObjectMat.color = Color.blue;//GetStepColor() * rat;
            }
        }

        protected override bool IsPlacingObject()
        {
	        return true; //currentAppState == AppState.DemoStepCreateLocalAnchor;
        }

        protected override Color GetStepColor()
        {
	        return Color.blue; //stateParams[currentAppState].StepColor;
        }
